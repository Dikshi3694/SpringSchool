...
public class StudentServiceTest {
    ...
    public void shouldFindStudentById() throws Exception {
        ...
        assertEquals("sameer@gmail.com", student.getEmail());
    }

    @Test
    public void shouldFindStudentByEmail() throws Exception {
        Student student = this.studentService.findByEmail("dikshita@gmail.com");
        assertEquals(2, student.getId());
        assertEquals("dikshita@gmail.com", student.getEmail());
    }
}
